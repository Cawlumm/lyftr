...
// tick, never decremented) so it never drifts and survives component re-mounts.
// Returns whole seconds remaining (>= 0), or null when `endsAt` is null. Fires
// `onComplete` exactly once when it first reaches 0.
