...
export default function AddWorkoutModal({ isOpen, onClose, onSuccess }: Props) {
  ...
  const cacheExercise = (ex: types.Exercise) => {
    setPickerExercises(prev => ({ ...prev, [ex.id]: ex }))
  }
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-surface-muted hover:bg-surface-muted/80 text-tx-secondary border border-surface-border rounded-lg transition-colors font-medium"
                >
