...
// Still exported here: web's services/api.ts re-exports it, and un-exporting is part of
// the web adoption slice, not this one. Keeping the surface additive means this can merge
// on its own without a web change riding along.
